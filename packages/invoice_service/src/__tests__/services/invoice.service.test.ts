...
describe("InvoiceService", () => {
    ...
    // Note: Les tests pour sendInvoiceByEmail et sendInvoiceWithPaymentLink ont été déplacés
    // vers invoice.controller.test.ts car la logique a été migrée vers le controller
